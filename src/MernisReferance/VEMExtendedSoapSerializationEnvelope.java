...
public class VEMExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(VEMDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new VEMStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static VEMDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static VEMDateTimeConverter dateTimeConverter = new VEMStandardDateTimeConverter();

    public VEMExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public VEMExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new VEMMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=VEMHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,VEMExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=VEMHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
