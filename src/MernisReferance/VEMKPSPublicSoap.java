...
public class VEMKPSPublicSoap
{
    ...
    public VEMKPSPublicSoap(){}

    public VEMKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public VEMKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        VEMExtendedSoapSerializationEnvelope envelope= new VEMExtendedSoapSerializationEnvelope(VEMExtendedSoapSerializationEnvelope.VER11);
